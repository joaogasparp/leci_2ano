...
static hash_table_node_t *find_word(hash_table_t *hash_table,const char *word,int insert_if_not_found)
{
  ...
  // ----
  // ciclo para percorrer a lista correspondente e ver
  // se encontra a palavra (com for, while,...)
  // strcmp para comprar palavras
  // se palavra encontrada -> return ponteiro para da palavra (não usar elses)
  // se ponteiro == NULL E não queremos inserir -> return NULL
